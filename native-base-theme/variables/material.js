...
export default {
  ...
  DefaultFontSize: 17,
  checkboxBgColor: "#2eb9f9",
  checkboxSize: 20,
  checkboxTickColor: "#fff",

  // Segment
  segmentBackgroundColor: "#2eb9f9",
  segmentActiveBackgroundColor: "#fff",
  segmentTextColor: "#fff",
  segmentActiveTextColor: "#2eb9f9",
  segmentBorderColor: "#fff",
  segmentBorderColorMain: "#2eb9f9",
  ...
  radioSelectedColorAndroid: "#2eb9f9",
