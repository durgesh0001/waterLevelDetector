...
import {Container,Content,FooterTab,Footer, Button as ButtonNative,CardItem, Text, Header, Form,Body, Title, Icon, Left} from 'native-base';
            ...
            return (
                <Form style={{backgroundColor:'transparent'}}>
                    <Card style={{backgroundColor:'transparent',elevation:0}}>
                        ...
                        <CardItem style={{backgroundColor:'transparent'}}>
                            <Password  isLengthMessageShow={true} iconName='lock' onEyeClick={this.onEyeClick.bind(this)} secureTextEntry={this.state.secureTextEntry} placeholder="password" label="Password"
