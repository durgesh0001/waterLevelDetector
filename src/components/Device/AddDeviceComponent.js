...
import {resetDeviceDetails,onDeviceIdChanged,onDeviceNameChanged,onTankNameChanged,onTankLocationChanged,onTankHeightChanged,onTankWidthChanged,onTankDepthChanged,addDevice,onTankTypeChanged} from '../../actions';
 ...
 */
    onButtonPress() {
        ...
        const {device_id, device_name,tank_name,tank_location,tank_height,tank_width,tank_depth,tank_type} = this.props;
        if(this.props.tank_type == 'horizontal_capsule')
        {
            if (device_id && device_name && tank_name && tank_location && tank_height && tank_width && tank_depth) {
                this.props.addDevice({device_id, device_name,tank_name,tank_location,tank_height,tank_width,tank_depth,tank_type});
            }
        }
        else
        {
...
*/
    ...
    renderContent() {
            return (
                ...
                <Form>
                            <CardItem>
                                <Input  placeholder="Device Id" label="Device Id" iconName="md-tablet-portrait"
                ...
                <CardItem>
                    ...
                    <CardItem>
                        <Text note>Tank Capacity:(Computed by system in ltr)</Text>
                    </CardItem>
    ...
    render() {
        ...
        return (
                <Container style={styles.containerBackgroundColor}>
                    <HeaderComponent label="Add Device" onPress={this.onSideMenuChange.bind(this)} isBackActive={true} isSettingActive={false}/>
                    <Content >
                        {this.renderContent()}
                    </Content>
                </Container>
...
const mapStateToProps = ({device}) => {
     const {device_id, device_name,tank_name,tank_location,loading,tank_height,tank_width,tank_depth,tank_type} = device;
    return {device_id, device_name,tank_name,tank_location,loading,tank_height,tank_width,tank_depth,tank_type};

};

export default connect(mapStateToProps, {resetDeviceDetails,onDeviceIdChanged,onDeviceNameChanged,onTankNameChanged,onTankLocationChanged,onTankHeightChanged,onTankWidthChanged,onTankDepthChanged,addDevice,onTankTypeChanged})(AddDeviceComponent);
