import {EMAIL_CHANGED,SUPPLIER_FETCH_SUCCESS,NAME_CHANGED,SUPPLIER_FETCH_SUCCESS_FILTER,QUERY_CHANGED,SUBMIT_QUERY_SUCCESS,SUBMIT_QUERY_FAIL,ALERT_FETCH_SUCCESS,LoadingStart} from '../../actions/types';
const INITIAL_STATE = {email:'',name:'',query:'',error:'',loading:false,alerts:'',suppliers:[],suppliersTemp:[]};
export default (state=INITIAL_STATE,action) =>
{
    switch(action.type)
    {
        ...
        case SUPPLIER_FETCH_SUCCESS_FILTER:
            return {...state,loading:false,suppliersTemp:action.payload}
        case LoadingStart:
